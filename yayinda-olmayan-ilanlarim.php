...
$ilansor=$db->prepare("SELECT * FROM urun where kullanici_id=:kullanici_id  and (urun_durum=\"0\" or urun_durum=\"2\") order by urun.urun_id desc ");
                ...
                <form action="admin/adminislem/islem.php" method="POST">
                  ...
                  while($ilancek=$ilansor->fetch(PDO::FETCH_ASSOC)) {?>
                    ...
                    <tbody >
                      <tr>
                        <td  >
                          <a href="ilan-detay.php?ilan_no=<?php echo $ilancek['urun_id'] ?>"><img  src="admin/adminislem/thumbnail/<?php echo $ilancek['urun_image']  ?>" alt="product" class="img-fluid  "></a>
                        </td>
                        <td class="text-left">
                          ...
                          <td>
                            ...
                            <div align="right" > <span class="dark-data">Fiyat <br></span> <?php echo number_format($ilancek['urun_fiyat'],0, ',', '.' ); ?><span> TL</span>
                             ...
                             <div align="right">
                               ...
                               <?php if ($ilancek['urun_durum']==2) {?><li><button  onclick="return confirm('Bu ürünü yayınlamak istiyor musunuz?')" name="ilanyayinla" class="btn btn-success btn-sm mb-2" value="<?php echo $ilancek['urun_id'] ?>" ><i class="fa fa-refresh mr-2"></i>Tekrar Yayınla</button></a></li>
