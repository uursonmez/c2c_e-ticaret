...
$ilansor=$db->prepare("SELECT * FROM urun where urun_durum=\"0\" order by urun.urun_zaman desc ");
$ilansor->execute();
 ?>
                            ...
                            <tbody>
                              ...
                              while($ilancek=$ilansor->fetch(PDO::FETCH_ASSOC)) {?>
                                <tr>
                                  ...
                                  <td><center><button  name="ilan_onay" class="btn btn-success btn-sm mb-2" value="<?php echo $ilancek['urun_id'] ?>" ><i class="fa fa-minus-circle mr-2"></i>Onay</button></center></td>
