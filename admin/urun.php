                            ...
                            <tbody>
                              ...
                              while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                                ...
                                <tr>
                                  ...
                                  <td><center><a href="urun-duzenle.php?urun_id=<?php echo $uruncek['urun_id']?>"<button type="button" class="btn btn-primary btn-sm ">Düzenle</button></a></center></td>
                                  <td><center><a href="adminislem/islem.php?urun_id=<?php echo $uruncek['urun_id']?>&urunsil=ok"><button type="button" class="btn btn-danger btn-sm">Sil</button></a></center></td>
                                </tr>
