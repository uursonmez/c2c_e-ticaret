                        ...
                        <div class="card-body">
                            <form action="adminislem/islem.php" method="POST" class="needs-validation">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" placeholder="kategori ad giriniz" name="kategori_ad" required="">
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control col-md-8" id="validationCustom0" placeholder="kategori sıra giriniz" type="text"  name="kategori_sira" required="">
                                </div>
                                ...
                                <button type="submit" name="kategoriekle"  class="btn btn-primary d-block">Kaydet</button>
                            </form>
                        </div>
