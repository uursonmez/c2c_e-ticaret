...
function calculate($height, $width, $image_height, $image_width){
  ...
  return array_merge($new, array("x"=>$x,"y"=>$y));
}

function output($image, $dest, $format, $quality){
  switch($format){
    case "jpg":
...
//buradan fotoğraf boyutunu değiştir uur
function thumb(
  $file,
  $dest,
  $height = 150,
  ...
  $calc = calculate($height, $width, $image_height, $image_width);
