                        ...
                        <div class="card-body">
                            <form action="adminislem/islem.php" method="POST" class="needs-validation">
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>kategori Ad</label>
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" value="<?php echo $kategoricek['kategori_ad'] ?>" name="kategori_ad" required="">
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>kategori Sıra</label>
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" value="<?php echo $kategoricek['kategori_sira'] ?>" name="kategori_sira" required="">
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Kategori Durum</label>
                                ...
                                <button type="submit" name="kategoriduzenle" class="btn btn-primary d-block">Güncelle</button>
