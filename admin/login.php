                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form action="adminislem/islem.php" method="POST" class="form-horizontal auth-form">
                                        <div class="form-group">
                                            <input required="" name="kullanici_mail" type="email" class="form-control" placeholder="Mail" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="kullanici_password" type="password" class="form-control" placeholder="Parola">
                                        </div>
                                        <div class="form-terms">

                                        </div>
                                        <div class="form-button">
                                            <button class="btn btn-primary" name="admingiris" type="submit">Login</button>
                                        </div>
