                        ...
                        <div class="card-body">
                            <form action="adminislem/islem.php" method="POST" class="needs-validation">
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Analystic</label>
                                    <input class="form-control col-md-8" id="validationCustom0" type="text" value="<?php echo $ayarcek['ayar_analystic'] ?>" name="ayar_analystic" required="">
                                </div>

                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Maps API</label>
                                    <input class="form-control col-md-8" id="validationCustom0" type="text" value="<?php echo $ayarcek['ayar_maps'] ?>"  name="ayar_maps" required="">
                                </div>

                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Zopim API</label>
                                    <input class="form-control col-md-8" id="validationCustom0" type="text" value="<?php echo $ayarcek['ayar_zopim'] ?>" name="ayar_zopim" required="">
                                </div>


                                <button type="submit" name="apiayarkaydet" class="btn btn-primary d-block">Güncelle</button>
                            </form>
                        </div>
