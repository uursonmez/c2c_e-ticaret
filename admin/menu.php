                            ...
                            <tbody>
                              ...
                              while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                                ...
                                <tr>
                                  ...
                                  <td><center><a href="menu-duzenle.php?menu_id=<?php echo $menucek['menu_id']?>"<button type="button" class="btn btn-primary btn-sm ">Düzenle</button></a></center></td>
                                  <td><center><a href="adminislem/islem.php?menu_id=<?php echo $menucek['menu_id']?>&menusil=ok"><button type="button" class="btn btn-danger btn-sm">Sil</button></a></center></td>
                                </tr>
