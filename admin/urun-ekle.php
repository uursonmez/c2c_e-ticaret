                        ...
                        <div class="card-body">
                            <form action="adminislem/islem.php" method="POST" class="needs-validation">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" placeholder="Ürün Adını Giriniz.." name="urun_ad" required="">
                                </div>
                                ...
                                <textarea  class="ckeditor" id="editor1" name="urun_detay" placeholder="Ürün Detay Giriniz.."></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" placeholder="Ürün Fiyat Giriniz.." name="urun_fiyat">
                                </div>

                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Ürün Keyword</label>
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" placeholder="Ürün Keyword Giriniz.." name="urun_keyword" required="">
                                </div>

                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span>Ürün Stok</label>
                                    <input class="form-control col-md-8" id="validationCustom0"  type="text" placeholder="Ürün Stok Giriniz.." name="urun_stok" required="">
                                </div>
                                ...
                                <button type="submit" name="urunkaydet" class="btn btn-primary d-block">Kaydet</button>
                            </form>
                        </div>
