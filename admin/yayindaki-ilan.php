...
$ilansor=$db->prepare("SELECT * FROM urun where urun_durum=\"1\" order by urun.urun_zaman desc ");
$ilansor->execute();
 ?>
                ...
                <div class="col-xl-8 xl-100">
                    <div class="card btn-months">
                        ...
                        <div class="card-body">
                          ...
                          <form  action="adminislem/islem.php" method="post">
                            ...
                            <tbody>
                              ...
                              while($ilancek=$ilansor->fetch(PDO::FETCH_ASSOC)) {?>
                                <tr>
                                  ...
                                  <td><center><button  onclick="return confirm('Bu ürünü yayından kaldırmak istiyor musunuz?')" name="ilan_kaldir" class="btn btn-danger btn-sm mb-2" value="<?php echo $ilancek['urun_id'] ?>" ><i class="fa fa-minus-circle mr-2"></i>İlandan Kaldır</button></center></td>
                                </tr>
                              <?php } ?>
                            </tbody>
                          </table>
